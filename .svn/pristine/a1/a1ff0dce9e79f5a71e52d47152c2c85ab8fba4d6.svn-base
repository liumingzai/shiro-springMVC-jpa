...
var ArtDlg=(function(){
            ...
            content:'<div class="position_close">' +
                      '<div class="popup_text">' +
                        '<table width="100%" border="0">' +
                          '<tbody>' +
                            '<tr class="popup_tr">' +
                              '<td class="popup_text_center">' +
                                '<h4>温馨提示</h4>' +
                                '<p class="note_p">任务执行成功</p>' +
                              '</td>' +
                            '</tr>' +
                          '</tbody>' +
                        '</table>' +
    ...
    //导出按钮：提示需要选择项目才能执行操作
    ArtDlg.prototype.showArtDlg=function(msg,width){
        var d = dialog({
            title: '温馨提示',
            content:'<div class="position_close">' +
            '<div class="popup_text">' +
    ...
    //帮助按钮：蓝色问号按钮解析
    ArtDlg.prototype.showBluehelp=function(msg,width){
        var d = dialog({
            title: '提示',
            content:'<div class="position_close">' +
                      '<div class="popup_text">' +
                        '<table width="100%" border="0">' +
                          '<tbody>' +
                            '<tr>' +
                              '<td>' +
                                '<p class="note_p" style="font-size:12px;">'+msg+'</p>' +
                              '</td>' +
                            '</tr>' +
                          '</tbody>' +
                        '</table>' +
    ...
    //
    ArtDlg.prototype.showArtTip=function(msg,obj) {
        var d = dialog({
            content: "<div style='font-size: 10px;padding: 8px 5px 5px 5px'>" + msg + "</div>",
            quickClose: true,
            align: 'bottom right',
            width: "auto",
            height:35
    ...
    //数据整合按钮：提示数据整合的内容到任务列表中查看
    ArtDlg.prototype.showArtConfirm=function(msg,callback) {
        var d = dialog({
            title: '提示',
            content: '<div class="position_close">' +
                      '<div class="popup_text">' +
                        '<table width="100%" border="0">' +
                          '<tbody>' +
                            '<tr>' +
                              '<td>' +
                                '<p class="note_p"  style="font-size:12px;">该任务'+msg+'已经整合，是否强制整合该任务！</p>' +
                              '</td>' +
                            '</tr>' +
                          '</tbody>' +
                        '</table>' +
    ...
    ArtDlg.prototype.showArtConfirm1=function(msg,callback) {
        var d = dialog({
            title: '提示',
            content: '<div class="position_close">' +
            '<div class="popup_text">' +
    ...
    //添加按钮：添加账户需要的信息
    ArtDlg.prototype.showAddAccount=function(msg,callback,content) {
        var d = dialog({
            title: '提示',
            content: '<div class="position_close">' +
                      '<div class="popup_text">' +
                        '<table width="100%" border="0">' +
                          '<tbody>' +
                            '<tr>' +
                              '<td>' +
                                '<h4 class="popup_title">添加账户</h4>' +
                                '<div class="add_account clearfix mb10">' +
                                  '<label>广告主名称：</label>' +
                                  '<input class="text" type="text" value="广告主名称/录入广告主名称，系统给出名称推荐" />' +
                                '</div>' +
                                '<div class="add_account clearfix">' +
                                  '<label>产品名称：</label>' +
                                  '<div class="dropdown mb10">' +
                                    '<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">' +
                                      '请选择产品' +
                                      '<span class="caret"></span>' +
                                    '</button>' +
                                    '<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">' +
                                      '<li role="presentation"><a role="menuitem" tabindex="-1" href="#">请选择产品</a></li>' +
                                    '</ul>' +
                                  '</div>' +
                                '</div>' +
                                '<div class="add_account clearfix mb10">' +
                                ...
                                '<div class="add_account clearfix mb10">' +
                                  '<label>账户名称*：</label>' +
                                  '<input class="text" type="text" value="录入名称" />' +
                                '</div>' +
                                '<div class="add_account clearfix mb10">' +
                                  '<label>账户密码*：</label>' +
                                  '<input class="text" type="text" value="录入名称" />' +
