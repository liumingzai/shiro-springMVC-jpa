...
<body>
<#if adminView ?? && adminView == true>
    <a href="${CONTEXT_PATH}/index">进入Index页面</a><p />
    <#else>
        <a href="${CONTEXT_PATH}/admin">进入Admin页面</a><p />
</#if>
<a href="${CONTEXT_PATH}/noAuth">进入NoAuth页面</a><p />
<a href="${CONTEXT_PATH}/logout">退出</a><p />
