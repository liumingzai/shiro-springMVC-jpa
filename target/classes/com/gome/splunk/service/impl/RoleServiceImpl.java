...
public class RoleServiceImpl implements RoleService {
    ...
    public List<UserRoleVo> findRoleByUserId(Integer uid) {
       String hql = "select new " + UserRoleVo.class.getName() +
                "(" +
                "p.id," +
                "u.id," +
                "r.id" +
                " ) from UserRoleEntity as p " +
                " left join p.userByUserId as u " +
        ...
        return userRoleDao.findList(UserRoleVo.class,hql,params);
    }
